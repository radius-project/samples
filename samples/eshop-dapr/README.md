...
Visit the [Radius docs](https://radapp.io/getting-started/reference-apps/eshop-dapr/) to learn more.
...
1. [Install the rad CLI](https://radapp.io/getting-started/)

1. [Initialize a new Radius environment](https://radapp.io/getting-started/)
