...
This Radius application will have two [containers](https://docs.radapp.io/concepts/why-radius/application-graph/):
...
Radius offers communication between services via [Routes](https://docs.radapp.io/reference/resources/applications/applications.core/2023-10-01-preview/httproutes/).

### Dapr service invocation

In this quickstart we will be using a [Dapr HTTP invoke route](https://docs.radapp.io/reference/resources/applications/applications.core/2023-10-01-preview/httproutes/) resource to model communication from `frontend` to `backend`. This allows `frontend` to use Dapr service invocation to interact with `backend`.

<img src="images/invoke.png" alt="A diagram of the Dapr service invocation" width=500 />

## Link

A [Dapr statestore link](https://docs.radapp.io/reference/resource-schema/dapr-schema/secretstore/) is used to model and deploy the Dapr statestore component.
