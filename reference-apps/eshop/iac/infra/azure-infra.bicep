...
resource redisBasket 'Applications.Link/redisCaches@2022-03-15-privatepreview' = {
  ...
  properties: {
    ...
    secrets: {
      ...
      connectionString: '${basketCache.properties.hostName}:${basketCache.properties.sslPort},password=${basketCache.listKeys().primaryKey},abortConnect=False'
    }
  }
}
...
resource redisKeystore 'Applications.Link/redisCaches@2022-03-15-privatepreview' = {
  ...
  properties: {
    ...
    secrets: {
      ...
      connectionString: '${keystoreCache.properties.hostName}:${keystoreCache.properties.sslPort},password=${keystoreCache.listKeys().primaryKey},abortConnect=False'
    }
  }
}
